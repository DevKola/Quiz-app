...
function LightDarkMode({ toggleMode, onToggle }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        className="bg-[#A729F5] h-5 w-10 p-1 rounded-full relative duration-1000"
        onClick={onToggle}
      >
        <span
          className={`absolute h-3 w-3 bg-white rounded-full m-auto left-1 top-0 bottom-0 ${
            toggleMode ? "-right-4" : ""
